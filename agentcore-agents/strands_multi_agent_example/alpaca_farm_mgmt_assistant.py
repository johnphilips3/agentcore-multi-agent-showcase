...
ALPACA_FARM_MANAGEMENT_ASSISTANT_SYSTEM_PROMPT = """
...
@tool
def farm_assistant(query: str) -> str:
    """
    ...
    try:
        ...
        print("Routed to Alpaca Farm Management Assistant")
        ...
        with client:
            ...
            # Create the computer science agent with relevant tools
            farm_agent = Agent(
                system_prompt=ALPACA_FARM_MANAGEMENT_ASSISTANT_SYSTEM_PROMPT,
                tools=[tools],
            )
